    ...
    <section id="projects" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
          <div>
            <h2 className="text-4xl font-bold mb-4 outfit">Curated Works</h2>
            <p className="text-gray-500 text-sm max-w-md">A selection of architectures designed for performance and purpose.</p>
          </div>
          <p className="text-xs font-bold tracking-widest text-gray-600 uppercase">Scroll to explore</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Featured Project */}
          <div className="md:col-span-8 group">
            <div className="relative aspect-[16/10] glass-card rounded-3xl overflow-hidden mb-8">
              ...
              <div className="absolute bottom-8 left-8 z-20">
                ...
                <h3 className="text-4xl font-bold mb-2 outfit">SaaS AI Platform</h3>
          ...
          <div className="md:col-span-4 flex flex-col gap-8">
            <div className="glass-card rounded-3xl p-8 flex-1 group hover:border-secondary-glow/30">
            ...
            <div className="glass-card rounded-3xl p-8 flex-1 group hover:border-primary-glow/30">

...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-primary-glow/10 rounded-full blur-[120px] animate-glow-pulse" />
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-secondary-glow/10 rounded-full blur-[120px] animate-glow-pulse" />

      <div className="max-w-7xl mx-auto px-6 relative z-10 py-16 md:py-32">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-7">
            {/* <div className="inline-block px-3 py-1 rounded-full border border-white/10 bg-white/5 text-[10px] font-bold tracking-widest text-gray-400 mb-8 uppercase">
          ...
          <div className="md:col-span-5">
            ...
            <div className="relative aspect-square max-w-[300px] md:max-w-none mx-auto rounded-3xl overflow-hidden glass-card p-2">
              ...
              {/* Decorative Glow */}
              <div className="absolute -inset-1 bg-gradient-to-br from-primary-glow/20 to-transparent blur-2xl -z-10" />
            </div>
          </div>
        </div>
      </div>
